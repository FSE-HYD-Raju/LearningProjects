import { BasketItem, ProductOffering, Agreement } from "../../redux";

const basketItems: Array<BasketItem> = [
	{
		id: "50fb2d30-985f-4cd4-a0e8-ee28dc9b95b8",
		type: "basketItems",
		attributes: {
			basketProductId: "0dd8cffa-41b0-4233-babf-dbfd71bd4523",
			product: {
				id: "earplug1-po",
				...
				instanceCharacteristics: {
					...
					T_FORM_NAME: {
						...
						"data-type": "string",
						description:
							"Form which should be used to present the fields associated with this product.",
						cardinality: null,
						hidden: null,
						"sub-type": "Internal",
						purpose: null,
			...
			quantity: 1,
			lastModifiedAt: "2018-02-23T14:59:30.528Z",
			...
			createdAt: "2018-02-23T14:59:30.528Z",
		...
		relationships: {
			basket: {
				data: {
					id: "959662fe-e5a3-47f7-917b-393e642d19d6",
					type: "baskets"
				},
				links: {
					self:
						"http://omnichannel_monolith:8080/omnichannel-api/api/v0/basketItems/50fb2d30-985f-4cd4-a0e8-ee28dc9b95b8/relationships/basket",
					related:
						"http://omnichannel_monolith:8080/omnichannel-api/api/v0/basketItems/50fb2d30-985f-4cd4-a0e8-ee28dc9b95b8/basket"
				}
			}
		},
		links: {
			self:
				"http://omnichannel_monolith:8080/omnichannel-api/api/v0/basketItems/50fb2d30-985f-4cd4-a0e8-ee28dc9b95b8"
		}
	}
] as any as Array<BasketItem>;

const poMvpBase: ProductOffering = {
    id: "PO_MVP_Base",
    attributes:
    {
        specificationId: "PO_MVP_Base",
        specType: "PRODUCT",
        instanceCharacteristics: {},
        productId: null,
        priority: null,
        ...
        },
        {
            ...
            commercialEnrichments: null,
            id: "GRP_Data_Add_On",
            name: "Select a Data Add On",
            msisdnGroup: false,
            productOfferings: [
            {
                id: "PO_Data_1GB",
                name: "Add On Package with 1GB Data",
                categories: [],
                commercialEnrichments: [
                {
                    conditions:
                    ...
                    descriptions:
                    {
                        "long-description": "PO_Data_1GB 1GB Add On for PO MVP Product Family",
                        "short-description": "1GB Data Add On"
                    },
                    media:
                    {},
                    names:
        ...
        },
        {
            ...
            productOfferings: [
            {
                ...
                commercialEnrichments: [
                {
                    ...
                    descriptions:
                    {
                        "long-description": "PO_MVP_Smart_TopUp",
                        "short-description": "PO_MVP_Smart_TopUp"
                    },
                    media:
                    {},
                    names:
            ...
            },
            {
                ...
                commercialEnrichments: [
                {
                    ...
                    descriptions:
                    {
                        "long-description": "PO_MVP_Threshold_TopUp",
                        "short-description": "PO_MVP_Threshold_TopUp"
                    },
                    media:
                    {},
                    names:
            ...
            },
            {
                ...
                name: "PO_MVP_Time_Monthly_TopUp",
                categories: [],
                commercialEnrichments: [
                {
                    conditions:
                    ...
                    descriptions:
                    {
                        "long-description": "PO_MVP_Time_Monthly_TopUp",
                        "short-description": "PO_MVP_Time_Monthly_TopUp"
                    },
                    media:
                    {},
                    names:
            ...
            },
            {
                ...
                commercialEnrichments: [
                {
                    ...
                    descriptions:
                    {
                        "long-description": "PO_MVP_Time_Weekly_TopUp",
                        "short-description": "PO_MVP_Time_Weekly_TopUp"
                    },
                    media:
                    {},
                    names:
    ...
    relationships:
    {
        bundlingProductOfferings:
        {
            links:
            {
                self: "http://omnichannel-monolith/omnichannel-api/api/v0/contextualProducts/PO_MVP_Base/relationships/bundlingProductOfferings",
                related: "http://omnichannel-monolith/omnichannel-api/api/v0/contextualProducts/PO_MVP_Base/bundlingProductOfferings"
            }
        },
        msisdns:
        {
            links:
            {
                self: "http://omnichannel-monolith/omnichannel-api/api/v0/contextualProducts/PO_MVP_Base/relationships/msisdns",
                related: "http://omnichannel-monolith/omnichannel-api/api/v0/contextualProducts/PO_MVP_Base/msisdns"
            }
        },
        alternateProductOfferings:
        {
            links:
            {
                self: "http://omnichannel-monolith/omnichannel-api/api/v0/contextualProducts/PO_MVP_Base/relationships/alternateProductOfferings",
                related: "http://omnichannel-monolith/omnichannel-api/api/v0/contextualProducts/PO_MVP_Base/alternateProductOfferings"
            }
        }
    }
...
export { basketItems, poMvpBase, agreementWithRecurringTopUps };
